...
print  """
\033[1;97m************************************************
\033[1;96m~ IM NOT RESPONSIBLE FOR ANY MISS USE MR ZFS  ~
\033[1;97m************************************************
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.Facebook.cim/xihan.ahmed.786')
    else:
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mZIHAN AHMED\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mZIHAN ZFS\033[1;95m◈•══════•◈•"
		try:
	...
	jalan('          \033[1;91mZFS start cloning Wait...')
	print  "  \033[1;92m ◄══════════════════ZfS══════════════════►" 
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;94m[  ✓  ] \x1b[1;92mZfS-Hack100%'											
	...
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬•◈\033[1;91mZIHAN-ZFS\033[1;95m◈•▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By ZIHAN-ZFS--•◈•---»" #Dev:ZFS
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ..Zfs Creations.. \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91mxihan.ahmed.786"""
